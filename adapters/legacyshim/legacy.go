...
func (w *Wrapper) Detect(ctx context.Context, fsys fs.FS, logSink core.LogSink) (core.StackInfo, bool, error) {
	...
	info, found, err := w.detector.Detect(ctx, os.DirFS(tmpDir), logSink)
